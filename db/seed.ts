	...
	await db.insert(Service).values([
		{
			...
			"description_en": "Goodbye to accumulated dead cells, blackheads, milium cysts, and pustules! In 10 steps, I improve your skin's health and appearance by removing impurities and revitalizing it. I deeply cleanse, remove dead cells, extract blackheads, milium cysts, and pustules, apply serums to treat specific issues, and hydrate at all levels, leaving your skin flawless.",
			"recomendation_es": "",
			"recomendation_en": "",
