                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex justify-between">
                            ...
                            <button onClick={() => addToCart(product)} className="flex bg-green-verbena hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-full mr-2">Add to Cart</button>
